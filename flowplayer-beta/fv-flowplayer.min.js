...
flowplayer( function(api,root) {
  ...
  root.one( 'click', function() {
    if( api.conf.clip.sources[0].type.match(/dash/) || api.conf.playlist[0].sourcec[0].type.match(/dash/) ) { // todo: improve to check all sources and also Vimeo in FV Player Pro
